...
The official Shipwright project offers zipped builds, but hosting the AppImage artifacts directly can be useful for automations or other specific needs. This project uses GitHub Actions to:
